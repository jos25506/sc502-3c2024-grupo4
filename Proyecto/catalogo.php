                ...
                <div class="card shadow h-100">
                    ...
                    <div class="card-body">
                        ...
                        <?php if ($esAdmin): ?>
                            ...
                            <a href="php/botones/eliminar_producto.php?id=<?= $p['id_producto'] ?>" class="btn btn-danger" onclick="return confirm('¿Seguro que deseas eliminar este producto?');">🗑️ Eliminar</a>
                        <?php elseif (isset($_SESSION['id_usuario'])): ?>
                            <a href="carrito.php?id=<?= $p['id_producto'] ?>" class="btn btn-primary">🛒 Añadir al Carrito</a>
                        <?php else: ?>

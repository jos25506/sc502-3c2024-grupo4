...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
        <div class="container">
            <a class="navbar-brand fw-bold text-info" href="index.html">GameMasters</a>
  ...
  <ul class="navbar-nav ms-auto">
    ...
    <section class="hero bg-dark text-light text-center py-5">
        <div class="container">
            ...
            <p class="lead text-secondary">Mantente al día con los lanzamientos, eventos y curiosidades más recientes del universo gamer.</p>
        </div>
    </section>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-sm border-0">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Después de años de espera, Rockstar Games anuncia la fecha oficial de lanzamiento de GTA VI junto con un nuevo tráiler lleno de acción.</p>
                        <button class="btn btn-outline-info btn-sm" data-bs-toggle="modal" data-bs-target="#modalGTA">Leer más</button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-sm border-0">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Nintendo sorprende con un nuevo título de Zelda que promete revolucionar la saga con mecánicas nunca vistas.</p>
                        <button class="btn btn-outline-success btn-sm" data-bs-toggle="modal" data-bs-target="#modalZelda">Leer más</button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-sm border-0">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">El auge competitivo continúa creciendo con torneos internacionales y nuevas oportunidades para los jugadores profesionales.</p>
                        <button class="btn btn-outline-warning btn-sm" data-bs-toggle="modal" data-bs-target="#modalEsports">Leer más</button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-sm border-0">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-danger">Ghost of Yotei: Un precioso mundo abierto guiado por una historia de venganza</h5>
                        <p class="card-text">Ghost of Yotei es un videojuego precioso, especialmente por sus paisajes, que retratan la belleza de la región de Hokkaido.</p>
                        <button class="btn btn-outline-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modalyotei">Leer más</button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-sm border-0">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Nueva entrega de terror y supervivencia desarrollado y publicado por Capcom. Es la secuela de Resident Evil Village (2021) y la undécima entrega principal de la serie de videojuegos Resident Evil.</p>
                        <button class="btn btn-outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalResident">Leer más</button>
                    </div>
                </div>
            </div>
...
<div class="col-md-4">
  <div class="card h-100 shadow-sm border-0">
    <img src="imagenes/code-violet.jpg" class="card-img-top" alt="Próximos lanzamientos para lo que resta del año">
    <div class="card-body">
      <h5 class="card-title text-primary">Próximos Lanzamientos 2025</h5>
      <p class="card-text">Grandes estrenos que llegan este fin de año: nuevas entregas, sagas y títulos que dejaran de que hablar.</p>
      <button class="btn btn-outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalLanzamientos">Leer más</button>
    </div>
  </div>
</div>
    ...
    <div class="modal fade" id="modalyotei" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content bg-dark text-light">
                ...
                <div class="modal-body">
                    <p>Ghost of Yotei narrativamente se sitúa 300 años después y escoge la venganza como temática principal. Lo hace a través de una protagonista, Atsu, con la que logramos conectar casi inmediatamente. La narración cinematográfica está muy cuidada y es efectiva. Nos sumerge en el pasado traumático de una mujer que perdió a su familia ante sus ojos, con un dolor desgarrador que la persigue durante la aventura. La premisa evoluciona mientras jugamos, y comprobar hacia dónde nos dirige su propósito es tremendamente interesante.</p>
    ...
    <div class="modal fade" id="modalResident" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content bg-dark text-light">
                ...
                <div class="modal-body">
                    <p>La historia de Resident Evil Requiem se lleva a cabo en el año 2028, cuando se suceden eventos extraños en una ciudad del medio oeste estadounidense, es entonces cuando la agente del FBI Grace Ashcroft, es enviada a investigar las misteriosas muertes; todo ello sucediéndose en la ciudad estadounidense más cercana a donde estuvo alguna vez Raccoon City; siendo el Hotel Wrenwood, entre ambas, el lugar de las muertes, que además es el lugar donde la madre de Grace falleció hace ocho años.</p>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content bg-dark text-light">
      ...
      <div class="modal-body">
        ...
        <p>Este cierre de año es prometedor para los videojuegos. Desde aventuras épicas hasta simuladores de nueva generación, estos son los títulos más esperados que llegarán en los próximos meses:</p>
        ...
        <ul class="list-group list-group-flush bg-dark text-light mt-3">
          ...
          <li class="list-group-item bg-dark text-light border-secondary">
            <strong class="text-danger">Monster Hunter Stories 2: Wings of Ruin</strong> — Disponible en <em>Xbox</em>.  
